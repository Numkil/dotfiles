--- 
name: craft-plugins
description: "Plugin-specific Craft CMS 5 guidance. Routes to plugin docs for Formie, SEOmatic, Blitz, Feed Me, Imager-X, etc. Triggers when a plugin is named. Read references/<plugin>.md first."
---
