--- 
name: craft-garnish
description: "Craft CMS CP JavaScript (Garnish toolkit). ALWAYS load for CP JavaScript. Covers Garnish patterns, UI widgets, drag-sort, accessibility, and memory management. Triggers on Garnish.* patterns. Do NOT trigger for front-end JS."
---
