...
description: "Releasing Craft CMS plugins. Covers tagging, Packagist, GitHub releases, and version management. ALWAYS load for plugin releases. NOT for changelog entries or CI YAML."
---
