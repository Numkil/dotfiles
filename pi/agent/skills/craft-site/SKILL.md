---
name: craft-site
description: "Craft CMS 5 front-end Twig development — atomic design, template architecture, components, Vite buildchain. Covers atoms/molecules/organisms, props/extends/block, layout chains, view routing, content builders, image presets, Tailwind named-key collections, multi-brand CSS tokens, JS boundaries (Alpine/Vue, tabs, accordions), Vite assets, front-end auth. Triggers on: {% include ... only %}, {% embed %}, _atoms/_molecules/_organisms/_views/_builders, component variants, props, collect({}), utilities prop, data-brand, hero/card components, Matrix blocks, craft.vite.script, vite.php, buildchain, Blitz caching, ImageOptimize, Imager-X, responsive images, SEOmatic meta, Sprig, htmx, multi-language, Formie styling, login/registration, feeds, sitemaps, search, headless GraphQL, Next.js/Nuxt/Astro. Always use for front-end Twig, components, layouts, builders. NOT for PHP (craftcms) or content modeling (craft-content-modeling)."
---
